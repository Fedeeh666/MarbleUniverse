...
const scriptsInEvents = {
	...
	async Gamecode_Event112_Act62(runtime, localVars)
	{
		TelegramGameProxy.shareScore()
	},

	async Gamecode_Event113_Act62(runtime, localVars)
	{
		TelegramGameProxy.shareScore(runtime.globalVars.GlobalBitcoins)
	},

	async Menucode_Event2_Act56(runtime, localVars)
	{
		(function () {
		  var eventHandlers = {};
